...
CREATE TABLE PUBLIC.CARDS (
	ID BIGINT DEFAULT (NEXT VALUE FOR PUBLIC.CARDS_SEQUENCE) NOT NULL AUTO_INCREMENT,
	USERNAME VARCHAR(255),
	NUMBER VARCHAR(20),
	PIN VARCHAR(6),
	CONSTRAINT CARS_CONSTRAINT_ID PRIMARY KEY (ID)
);
CREATE UNIQUE INDEX CARDS_PK ON PUBLIC.CARDS (ID);
...
INSERT INTO PUBLIC.CARDS (USERNAME, NUMBER, PIN) VALUES
	('admin', '15875631210', '8756'),
	('denis.fresnel', '1234567890', '2563'),
	('florian.auger', '0987654321', '5412');
